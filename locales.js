...
module.exports = {
    'en': {
        ...
        'BULETOOTH.description': 'BULETOOTH REMOTE.',
        'BULETOOTH.name': 'BULETOOTH',
        ...
        'OUTPUT.description': 'OUTPUT drive module.',
        'OUTPUT.name': 'OUTPUT',
        'INPUT.description': 'INPUT drive module.',
        'INPUT.name': 'INPUT',
    ...
    'zh-cn': {
        ...
        'OUTPUT.description': '输出类。',
        'OUTPUT.name': '输出类',
        'INPUT.description': '输入类。',
        'INPUT.name': '输入类',
