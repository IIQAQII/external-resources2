 ...
 *    None
 */
uint8_t CKPS2::readBuffer(int16_t index)
{
  _index=index;
 ...
 *    None
 */
void CKPS2::writeBuffer(int16_t index,uint8_t c)
{
  _index=index;
  buffer[_index]=c;
}
 ...
 *    None
 */
int16_t CKPS2::MeAnalog(uint8_t button)
{
  int16_t result;
  if (!_isReady)
  {
 ...
 *    None
 */
boolean CKPS2::ButtonPressed(uint8_t button) 
{
...
boolean CKPS2::ButtonUp(uint8_t button) {
...
boolean CKPS2::NoButtonPress(void) {
